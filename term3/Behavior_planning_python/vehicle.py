...
class Vehicle(object):
    ...
    def choose_next_state(self, predictions):
        ...
        for state in possible_successor_states:
            ...
            trajectorys.append(trajectory_for_state)
    ...
    def prep_lane_change_trajectory(self, predictions, state):
        ...
        if self.get_vehicle_behind(predictions, self.lane):
            ...
            s, v, a = min([next_lane_new_kinematics, curr_lane_new_kinematics], key=lambda x: x[1]) #choose kinematics with lowest velocity,无论是快的往慢变道，还是慢的往快变道
