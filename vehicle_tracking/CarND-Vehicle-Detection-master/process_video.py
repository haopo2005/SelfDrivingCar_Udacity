...
def convert_color(image, cspace='RGB2YCrCb'):
    if cspace != 'RGB':
        if cspace == 'HSV':
...
def process_image(img):
    ...
    windows = find_cars(draw_img, cspace, 400, 650, 1.5, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins)
